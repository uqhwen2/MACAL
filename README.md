...
This toy example runs on the one-dimensional toy dataset for 20 random seeds, the training relys on the exact Guassian process from [GPyTorch](https://gpytorch.ai).
